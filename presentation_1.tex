...
\item As an example of the importance of using augmented phrases, consider the sentence:

\item As another example, consider ``Female population of urban india is 23 million''.  The shortest path between the arguments  (India, 23) is (Population, million) and thus a vanilla
system will yield the wrong extraction \textbf{ POP(India, 23 million)}, instead of the correct \textbf{POP(urban india, female population, 23 million)}.
